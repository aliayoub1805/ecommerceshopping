...
class _ProfileScreen extends State<ProfileScreen> {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: ListTile(
          ...
          leading: Icon(_userTileIcons[index], color: Theme.of(context).iconTheme.color ,),
        ),
      ),
    );
  }
  ...
  Widget userTitle(String title) {
    return Padding(
      ...
      child: Text(
        title,
        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 23 ,color:Theme.of(context).textSelectionTheme.selectionColor ),
      ),
    );
  }
}
